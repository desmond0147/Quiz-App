...
## Bugs
### Solved Bugs
- When using Wave evaluation to check each page, there were  errors related to Arial and low contrast. These were fixed as follows:
  ```html
   <a href="https://www.github.com/desmond0147" target="_blank" rel="noopener" aria-label="Visit our GitHub page (opens in new tab)">
   <i class="fab fa-github" aria-hidden="true"></i> And the low contrast was fixed through Devtools element.


## Validation Testing

- **HTML**: No errors were returned when passing through the official W3C validator, wave evalution tools.
...
- **Clone the repository**: Start by cloning the repository to your local machine using the following command:git clone https://desmond0147.github.io/Quiz-App/

- **Navigate to the project directory**: Change into the project directory: cd Quiz-App
...
- Tha code to fixed the arial was taken from w3Schools.
